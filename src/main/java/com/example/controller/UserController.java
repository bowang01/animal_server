...
public class UserController {
    ...
    public Result reset(@RequestBody UserPasswordDTO userPasswordDTO) {
        if (StrUtil.isBlank(userPasswordDTO.getUsername()) || StrUtil.isBlank(userPasswordDTO.getPhone())) {
            throw new ServiceException("-1", "Invalid parameters");
        }
    ...
    public void export(HttpServletResponse response) throws Exception {
        ...
        // Create writer via utility Write to disk path
//        ExcelWriter writer = ExcelUtil.getWriter(filesUploadPath + "/User Info.xlsx");
        ...
        String fileName = URLEncoder.encode("User Info", "UTF-8");
    ...
    public Result imp(MultipartFile file) throws Exception {
        ...
        // Option 1 (recommended): read Excel as JavaBeans; headers must be English and match properties
//        List<User> list = reader.readAll(User.class);

        // Option 2: ignore Chinese headers and read sheet content
